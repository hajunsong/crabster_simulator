...
{
	 // json file direction
	std::string path = ros::package::getPath("crabster_visual");
	std::string data_dir = path + "/data/input_data/";

	std::string sim_param_file = "AA_Simulation_Parameter1.json";

	std::ifstream json_file(data_dir + sim_param_file, std::ifstream::binary);
